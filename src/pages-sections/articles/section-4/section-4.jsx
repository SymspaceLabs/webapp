...
export default async function Section4() {
  ...
  return <Box sx={{ py:10, background:'#353535' }}>
      <Container>
        <H2 sx={{ textAlign:'center', color:'#fff', pt:8, pb:3, fontFamily: 'Elemental End', textTransform: 'lowercase', fontSize: { xs: 30, sm: 30, md: 30, lg: 30, xl: 30 } }}>
          Shop Men
        </H2>
