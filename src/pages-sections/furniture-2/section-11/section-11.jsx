...
export const CustomCard1 = ({ number, description }) => {
  return (
    <Card sx={{ minWidth: 275, mb: 2, borderRadius: '50px' }}>
      <CardContent>
        <Box sx={{ px:5, pt:25, pb:5, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', gap:'30px' }} >
          <Typography variant="h1" component="div" sx={{ fontFamily:'Helvetica', color:'#000', fontSize: 72, fontWeight:'bold' }}>
            {number}
          </Typography>
          <Typography variant="body2" sx={{ fontFamily:'Helvetica', color:'#000', fontSize: 24, fontWeight:'bold', textAlign:'center' }}>
            {description}
          </Typography>
          <Button variant="outlined" sx={{ fontFamily:'Helvetica', mt:2, borderRadius:'50px', px:5, py:2, fontSize: 24,}}>Learn More</Button>
        </Box>
      </CardContent>
    </Card>
  );
...
export const CustomCard2 = () => {
  return (
    <Card sx={{ minWidth: 275, mb: 2, borderRadius: '50px', display: 'flex', flexDirection: 'column', height: '100%' }}>
      <CardContent sx={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: '30px' }}>
        <Typography variant="h1" component="div" sx={{ fontFamily: 'Helvetica', color: '#000', fontSize: 72, fontWeight: 'bold' }}>AR Visuals</Typography>
        <Typography variant="body2" sx={{  maxWidth: '650px', fontFamily: 'Helvetica', color: '#909090', fontSize: '14px', fontWeight: 'bold', textAlign: 'justify' }}>
...
export const CustomCard3 = () => {
  return (
    <Card sx={{ minWidth: 275, borderRadius: '50px', display: 'flex', flexDirection: 'column', height: 500, overflow: 'hidden' }}>
