      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">Equip Consumers with Confidence and Convenience</h2>
            <p className="text-lg text-slate-400">Transform 2D images & descriptive text of physical products into realistic 3D renders through generative AI models. Brands can now offer customers an accurate representation of how products look and fit. This not only enhances customer satisfaction but also minimizes the likelihood of returns, saving businesses valuable time and resources.</p>
          </div>
